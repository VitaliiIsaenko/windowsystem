...
public class Close extends CloseDecorator {
    ...
    public void draw() {
        ...
        Point exitStartPoint = new Point(simpleWindow.getCoordinates().getEndPoint().getX() - 15, simpleWindow.getCoordinates().getStartPoint().getY());
        Point exitEndPoint = new Point( simpleWindow.getCoordinates().getEndPoint().getX(), simpleWindow.getCoordinates().getStartPoint().getY() + 15);
